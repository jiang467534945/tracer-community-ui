      ...
      <avue-crud :option="tableOption"
        ...
        <template slot-scope="scope" slot="menu"  >
          ...
          <el-button type="danger"
                     icon="el-icon-delete"
                     size="small"
                     @click.stop="handleEdit(scope.row,scope.index)">删除</el-button>
          <el-button type="primary"
                     icon="el-icon-view"
                     size="small"
...
<script>
    import {getUserData,add,edit} from '@/api/user/user';
    ...
    export default {
        ...
        methods: {
            ...
            handleList () {
                ...
                getUserData({current: this.page.currentPage,size: this.page.pageSize}).then(res => {
                    setTimeout(() => {
            ...
            handleCurrentChange(val){
                console.log("当前分页是"+val);
                this.page.currentPage=val;
                console.log("当前分页是"+this.page.currentPage);
