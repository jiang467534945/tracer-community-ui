...
<script>
    import {getPageList,add,edit} from '@/api/test/TestDemo/TestDemo';
    import { mapGetters } from "vuex";
    import { testDemoOption } from "@/const/test/testDemo/TestDemoTableOption.js";
    export default {
        name: "TestDemo",
        components: {},
        data () {
            return {
                tableOption: testDemoOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
