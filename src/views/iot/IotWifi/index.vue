...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotWifi/IotWifi';
    import { mapGetters } from "vuex";
    import { iotWifiOption } from "@/const/iot/IotWifi/IotWifiTableOption.js";
    export default {
        name: "IotWifi",
        components: {},
        data () {
            return {
                tableOption: iotWifiOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
