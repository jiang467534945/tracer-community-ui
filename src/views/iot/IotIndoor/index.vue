...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotIndoor/IotIndoor';
    import { mapGetters } from "vuex";
    import { iotIndoorOption } from "@/const/iot/IotIndoor/IotIndoorTableOption.js";
    export default {
        name: "IotIndoor",
        components: {},
        data () {
            return {
                tableOption: iotIndoorOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
