...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotCallRecord/IotCallRecord';
    import { mapGetters } from "vuex";
    import { iotCallRecordOption } from "@/const/iot/IotCallRecord/IotCallRecordTableOption.js";
    export default {
        name: "IotCallRecord",
        components: {},
        data () {
            return {
                tableOption: iotCallRecordOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
