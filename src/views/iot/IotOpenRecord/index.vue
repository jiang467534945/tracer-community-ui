...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotOpenRecord/IotOpenRecord';
    import { mapGetters } from "vuex";
    import { iotOpenRecordOption } from "@/const/iot/IotOpenRecord/IotOpenRecordTableOption.js";
    export default {
        name: "IotOpenRecord",
        components: {},
        data () {
            return {
                tableOption: iotOpenRecordOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
