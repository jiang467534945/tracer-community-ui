...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotBrand/IotBrand';
    import { mapGetters } from "vuex";
    import { iotBrandOption } from "@/const/iot/IotBrand/IotBrandTableOption.js";
    export default {
        name: "IotBrand",
        components: {},
        data () {
            return {
                tableOption: iotBrandOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
