...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotMonitoring/IotMonitoring';
    import { mapGetters } from "vuex";
    import { iotMonitoringOption } from "@/const/iot/IotMonitoring/IotMonitoringTableOption.js";
    export default {
        name: "IotMonitoring",
        components: {},
        data () {
            return {
                tableOption: iotMonitoringOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
