...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotMonitoringFace/IotMonitoringFace';
    import { mapGetters } from "vuex";
    import { iotMonitoringFaceOption } from "@/const/iot/IotMonitoringFace/IotMonitoringFaceTableOption.js";
    export default {
        name: "IotMonitoringFace",
        components: {},
        data () {
            return {
                tableOption: iotMonitoringFaceOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
