...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotControlCard/IotControlCard';
    import { mapGetters } from "vuex";
    import { iotControlCardOption } from "@/const/iot/IotControlCard/IotControlCardTableOption.js";
    export default {
        name: "IotControlCard",
        components: {},
        data () {
            return {
                tableOption: iotControlCardOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
