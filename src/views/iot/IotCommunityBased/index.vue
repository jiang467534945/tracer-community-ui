...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotCommunityBased/IotCommunityBased';
    import { mapGetters } from "vuex";
    import { iotCommunityBasedOption } from "@/const/iot/IotCommunityBased/IotCommunityBasedTableOption.js";
    export default {
        name: "IotCommunityBased",
        components: {},
        data () {
            return {
                tableOption: iotCommunityBasedOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
