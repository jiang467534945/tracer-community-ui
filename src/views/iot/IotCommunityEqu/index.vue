...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotCommunityEqu/IotCommunityEqu';
    import { mapGetters } from "vuex";
    import { iotCommunityEquOption } from "@/const/iot/IotCommunityEqu/IotCommunityEquTableOption.js";
    export default {
        name: "IotCommunityEqu",
        components: {},
        data () {
            return {
                tableOption: iotCommunityEquOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
