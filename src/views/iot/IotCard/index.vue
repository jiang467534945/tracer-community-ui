...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotCard/IotCard';
    import { mapGetters } from "vuex";
    import { iotCardOption } from "@/const/iot/IotCard/IotCardTableOption.js";
    export default {
        name: "IotCard",
        components: {},
        data () {
            return {
                tableOption: iotCardOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
