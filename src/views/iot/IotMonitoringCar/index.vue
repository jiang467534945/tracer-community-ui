...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotMonitoringCar/IotMonitoringCar';
    import { mapGetters } from "vuex";
    import { iotMonitoringCarOption } from "@/const/iot/IotMonitoringCar/IotMonitoringCarTableOption.js";
    export default {
        name: "IotMonitoringCar",
        components: {},
        data () {
            return {
                tableOption: iotMonitoringCarOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
