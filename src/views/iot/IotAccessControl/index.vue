...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotAccessControl/IotAccessControl';
    import { mapGetters } from "vuex";
    import { iotAccessControlOption } from "@/const/iot/IotAccessControl/IotAccessControlTableOption.js";
    export default {
        name: "IotAccessControl",
        components: {},
        data () {
            return {
                tableOption: iotAccessControlOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
