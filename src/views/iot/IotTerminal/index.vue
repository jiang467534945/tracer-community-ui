...
<script>
    import {getPageList,add,edit,del} from '@/api/iot/IotTerminal/IotTerminal';
    import { mapGetters } from "vuex";
    import { iotTerminalOption } from "@/const/iot/IotTerminal/IotTerminalTableOption.js";
    export default {
        name: "IotTerminal",
        components: {},
        data () {
            return {
                tableOption: iotTerminalOption, //表格设置属性
                tableData: [], //表格的数据
                tableLoading: false,
                tabelObj: {},
                page: {
